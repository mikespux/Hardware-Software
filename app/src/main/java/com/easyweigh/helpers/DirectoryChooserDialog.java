...

{
    ...
    public DirectoryChooserDialog(Context context, String file_select_type, SimpleFileDialogListener SimpleFileDialogListener)
    {
        ...
        m_context = context;
        m_sdcardDirectory = Environment.getExternalStorageDirectory()+ "/" + "/Easyweigh/Masters/";
    ...
    public void chooseFile_or_Dir(String dir)
    {
        ...
        dialogBuilder.setPositiveButton("IMPORT", new OnClickListener()
        {
            @Override
                ...
                if (m_SimpleFileDialogListener != null){
                    {
                        if (Select_type == FileOpen || Select_type == FileSave)
                        {
                            ...
                            if(Selected_File_Name.equals("")){
                                ...
                                text.setText("Please select a file to import");
                                ...
                                customtoast.show();
                               // Toast.makeText(m_context.getApplicationContext(), "Please select a file to import !!", Toast.LENGTH_LONG).show();
        ...
        if ((dirsDialog == null) || !dirsDialog.isShowing()){
                                                             ...
                                                             DialogInterface.OnClickListener onClickListener)
    {
        ...
        m_titleView1.setBackgroundColor( m_context.getResources().getColor(android.R.color.white)); // dark gray 	-12303292
        ...
        m_titleView.setBackgroundColor( m_context.getResources().getColor(android.R.color.holo_blue_bright)); // dark gray -12303292
        ...
        if (Select_type == FileOpen || Select_type == FileSave)
        {
            ...
            input_text.setKeyListener(null);
        }
        //////////////////////////////////////////
