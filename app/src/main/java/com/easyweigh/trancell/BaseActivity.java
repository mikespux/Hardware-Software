...
import com.easyweigh.vsp.bt.BluetoothAdapterHelper;
import com.easyweigh.vsp.bt.BluetoothAdapterHelperCallback;
		...
		BluetoothAdapterHelperCallback
{
	...
	public boolean onCreateOptionsMenu(Menu menu)
	{
		...
		if (mBluetoothAdapterWrapper.isBleScanning() == true
				|| mBluetoothAdapterWrapper.isDiscovering() == true)
		{
