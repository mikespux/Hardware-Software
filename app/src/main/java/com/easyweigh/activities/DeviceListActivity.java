...
public class DeviceListActivity extends Activity {
    ...
    /* renamed from: com.octagon.easyweigh.activity.DeviceListActivity.1 */
                        ...
                        try {
                           // String lastUsedDevice = DeviceListActivity.this.mDbHelper.getLastUsedDevice();
                        	  ...
                        	  if (returnValue >= 1) {
                                  ...
                                  finish();
                                  intent = new Intent(DeviceListActivity.this, FarmerScaleWeighActivity.class);
                            ...
                            Log.e(DeviceListActivity.TAG, "DbException " + dbExecption.getMessage().toString());
                            return;
                        }
                    case 20:
                        DeviceListActivity.this.deviceUUID = UUID.randomUUID();
