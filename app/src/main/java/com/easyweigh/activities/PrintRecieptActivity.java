...
public class PrintRecieptActivity extends Activity {
	...
	public void onBackPressed() {
		...
		if(mSharedPrefs.getString("scaleVersion", "").toString().equals(EASYWEIGH_VERSION_15)){
			//showPrintDialog();
			finish();
			mIntent = new Intent(PrintRecieptActivity.this,FarmerScaleWeighActivity.class);
			startActivity(mIntent);
		}
		if(mSharedPrefs.getString("scaleVersion", "").toString().equals(MANUAL)){
			//showPrintDialog();
			finish();
			mIntent = new Intent(PrintRecieptActivity.this,FarmerManualWeighActivity.class);
			startActivity(mIntent);
		}
	}
	public void SMS() {
