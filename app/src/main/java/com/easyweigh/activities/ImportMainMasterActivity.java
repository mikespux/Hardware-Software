 ...
 */
public class ImportMainMasterActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if(Build.VERSION.SDK_INT>= Build.VERSION_CODES.M){
                    if (ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        ...
                        ActivityCompat.requestPermissions(ImportMainMasterActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},0);
    ...
    public void openfolder(){
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////
        DirectoryChooserDialog FileSaveDialog =  new DirectoryChooserDialog(ImportMainMasterActivity.this, "FileSave",new DirectoryChooserDialog.SimpleFileDialogListener()
                {
                    @Override
        ...
        protected void onPostExecute(String unused) {
           // dismissDialog(DIALOG_DOWNLOAD_PROGRESS);
            ...
            if (mSharedPrefs.getString("terminalID", "").toString().equals("")) {
                mIntent = new Intent(ImportMainMasterActivity.this,PreferenceOverallActivity.class);
            ...
            mIntent = new Intent(ImportMainMasterActivity.this,MainActivity.class);
            startActivity(mIntent);
