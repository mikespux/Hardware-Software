 ...
 */
public class AgentDeliveryReportActivity extends AppCompatActivity {
    ...
    public void initializer(){
        ...
        prefs = PreferenceManager.getDefaultSharedPreferences(AgentDeliveryReportActivity.this);
    ...
    public void getdata(){
        ...
        try {
            ...
            if (accounts.getCount() > 0) {
                ...
                ArrayAdapter = new DeliveryArrayAdapter(AgentDeliveryReportActivity.this, R.layout.delivery_list, arraylist);
    ...
    private class Restart extends AsyncTask<Void, Void, String>
    {
        ...
        protected void onPostExecute(String result)
        {
            ...
            mIntent = new Intent(getApplicationContext(),AgentDeliveryReportActivity.class);
            startActivity(mIntent);
        }
    }
