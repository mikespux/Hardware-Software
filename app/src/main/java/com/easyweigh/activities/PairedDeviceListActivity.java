...
public class PairedDeviceListActivity extends Activity {
    ...
    class C00731 implements OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View v, int arg2, long arg3) {
            ...
            try {
                ...
                SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(PairedDeviceListActivity.this);
             ...
             // Saving long
                    ...
                    case XmlPullParser.DOCDECL /*10*/:
                        try {
                           // String lastUsedDevice = DeviceListActivity.this.mDbHelper.getLastUsedDevice();
                            ...
                            Log.e(PairedDeviceListActivity.TAG, "DbException " + dbExecption.getMessage().toString());
                            return;
                        }
                    case 20:
                        PairedDeviceListActivity.this.deviceUUID = UUID.randomUUID();
               ...
               // Log.e(DeviceListActivity.TAG, "Error Getting Address " + e.getMessage().toString());
                ...
                Log.e(PairedDeviceListActivity.TAG, "Error Getting Address " + e.getMessage().toString());
            }
        }
    }

    /* renamed from: com.octagon.easyweigh.activity.DeviceListActivity.2 */
    ...
    /* renamed from: com.octagon.easyweigh.activity.DeviceListActivity.3 */
