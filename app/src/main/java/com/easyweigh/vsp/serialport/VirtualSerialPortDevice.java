...
package com.easyweigh.vsp.serialport;
...
import com.easyweigh.vsp.misc.FifoQueue;
...
public class VirtualSerialPortDevice extends BleBaseDeviceManager
{
	 ...
	 */
	protected static int MAX_DATA_TO_READ_FROM_BUFFER = 10;
	protected static String SEARCHFOR="<STX><POL><SP><LB/KG><SP><GR/NT>";
	/**
	...
	protected int SEND_DATA_TO_REMOTE_DEVICE_DELAY = 15;
	/**
